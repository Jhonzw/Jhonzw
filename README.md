...
<picture>
  ...
  <img alt="Atividade no GitHub" src="./assets/stats-dark.svg" width="100%">
</picture>

<sub>Cards gerados por [`scripts/render_cards.py`](./scripts/render_cards.py) direto da API do GitHub e commitados neste repo — sem serviço de terceiro pra sair do ar. A maior parte dos commits está em repositórios privados.</sub>
